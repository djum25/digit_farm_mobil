      ...
      appBar: PreferredSize(
        ...
        floatingActionButton: SpeedDial(
          ...
          children: [
            ...
            context: context,
            builder: (_) {
              return ReverseForm((advanceTotal.toInt() + int.parse(openAmount) +int.parse(reimburse)).toString());
        ...
        body: Container( 
          ...
          child: load? Center(child: Image.asset('images/loading.gif',width: 300.0,height: 300.0,),) : all ? itemListAll() :layout(),
    ));
  }
